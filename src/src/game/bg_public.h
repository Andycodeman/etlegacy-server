...
// ETMan: g_misc flags (JayMod-style) - defined here for bg_pmove.c access
#define G_MISC_SHOVE_Z          0x01  // 1 - Enable Z-axis shove boost
#define G_MISC_DOUBLE_JUMP      0x02  // 2 - Enable double jump
#define G_MISC_NO_FALL_DAMAGE   0x04  // 4 - Disable fall damage
#define G_MISC_UNLIMITED_SPRINT 0x08  // 8 - Unlimited sprint/stamina
#define G_MISC_NO_SELF_DAMAGE   0x10  // 16 - No self damage
#define G_MISC_PANZER_WAR       0x20  // 32 - All classes can use panzerfaust/bazooka
